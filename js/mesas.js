...
formMesa.addEventListener("submit", async (event) => {
    ...
    try {
        ...
        if (!resposta.ok) {
            ...
            throw new Error(
                dados.erro || "Erro ao cadastrar mesa"
            );
...
async function alterarMesa(id, numeroAtual, capacidadeAtual) {
    ...
    try {
        ...
        if (!resposta.ok) {
            ...
            throw new Error(
                dados.erro || "Erro ao alterar mesa"
            );
...
async function desativarMesa(id) {
    ...
    const confirmar = confirm(
        "Tem certeza que deseja desativar esta mesa?"
    );
    ...
    try {
        ...
        if (!resposta.ok) {
            ...
            throw new Error(
                dados.erro || "Erro ao desativar mesa"
            );
